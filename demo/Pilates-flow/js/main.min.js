...
/* harmony import */ var _modules_cards_slider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/cards-slider */ "./js/modules/cards-slider.js");
/* harmony import */ var _modules_filter_list_slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/filter-list-slider */ "./js/modules/filter-list-slider.js");
/* harmony import */ var _modules_padding_for_main__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/padding-for-main */ "./js/modules/padding-for-main.js");
...
/* harmony import */ var _modules_favorite_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/favorite-slider */ "./js/modules/favorite-slider.js");
/* harmony import */ var _modules_introduction_slider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/introduction-slider */ "./js/modules/introduction-slider.js");
/* harmony import */ var _modules_recommend_slider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/recommend-slider */ "./js/modules/recommend-slider.js");
/* harmony import */ var _modules_like_btn_change__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/like-btn-change */ "./js/modules/like-btn-change.js");
/* harmony import */ var _modules_comment_form_active__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/comment-form-active */ "./js/modules/comment-form-active.js");
/* harmony import */ var _modules_comment_form_reply__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/comment-form-reply */ "./js/modules/comment-form-reply.js");
/* harmony import */ var _modules_product_page_slider__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/product-page-slider */ "./js/modules/product-page-slider.js");
/* harmony import */ var _modules_auto_resize_textarea__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/auto-resize-textarea */ "./js/modules/auto-resize-textarea.js");
/* harmony import */ var _modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/modals/init-modals */ "./js/modules/modals/init-modals.js");
/* harmony import */ var _modules_form_validate_custom_select__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/form-validate/custom-select */ "./js/modules/form-validate/custom-select.js");
/* harmony import */ var _modules_form_validate_init_form_validate__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/form-validate/init-form-validate */ "./js/modules/form-validate/init-form-validate.js");
/* harmony import */ var _modules_form_validate_enter_submit_button__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/form-validate/enter-submit-button */ "./js/modules/form-validate/enter-submit-button.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_mobile_menu__WEBPACK_IMPORTED_MODULE_0__["initMobileMenu"])();
  Object(_modules_padding_for_main__WEBPACK_IMPORTED_MODULE_3__["initBottomMenu"])();
  Object(_modules_cards_slider__WEBPACK_IMPORTED_MODULE_1__["initSlider"])();
  Object(_modules_filter_list_slider__WEBPACK_IMPORTED_MODULE_2__["initFilterListSlider"])();
  Object(_modules_favorite_slider__WEBPACK_IMPORTED_MODULE_5__["initFavoriteSlider"])();
  Object(_modules_introduction_slider__WEBPACK_IMPORTED_MODULE_6__["initIntroductionSlider"])();
  Object(_modules_recommend_slider__WEBPACK_IMPORTED_MODULE_7__["initRecommendSlider"])();
  Object(_modules_product_page_slider__WEBPACK_IMPORTED_MODULE_11__["initProductPageSlider"])();
});
window.addEventListener('load', function () {
  Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_13__["initModals"])();
  Object(_modules_filter_list_slider__WEBPACK_IMPORTED_MODULE_2__["blurActiveFilterItem"])();
  Object(_modules_like_btn_change__WEBPACK_IMPORTED_MODULE_8__["initChangeLikeButton"])();
  Object(_modules_auto_resize_textarea__WEBPACK_IMPORTED_MODULE_12__["initAutoResizeTextarea"])();
  Object(_modules_comment_form_active__WEBPACK_IMPORTED_MODULE_9__["initformComment"])();
  Object(_modules_comment_form_reply__WEBPACK_IMPORTED_MODULE_10__["showReplyFormComment"])();
  Object(_modules_form_validate_enter_submit_button__WEBPACK_IMPORTED_MODULE_16__["enterSubmitButton"])();
  var select = new _modules_form_validate_custom_select__WEBPACK_IMPORTED_MODULE_14__["CustomSelect"]();
  select.init();
  Object(_modules_form_validate_init_form_validate__WEBPACK_IMPORTED_MODULE_15__["initFormValidate"])();
});
...
function initSlider() {
  var SLIDER_CONTAINER_SELECTOR = '.cards-slider__swiper-container';
  var sliderEl = document.querySelector(SLIDER_CONTAINER_SELECTOR);
  if (sliderEl) {
    // eslint-disable-next-line
    var slider = new Swiper(SLIDER_CONTAINER_SELECTOR, {
...
/***/ "./js/modules/comment-form-active.js":
/*!*******************************************!*\
  !*** ./js/modules/comment-form-active.js ***!
  \*******************************************/
/*! exports provided: initformComment */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initformComment", function() { return initformComment; });
...
var formCommentList = document.querySelectorAll('.form-comment');
function initformComment() {
  if (formCommentList.length) {
    var _iterator = _createForOfIteratorHelper(formCommentList),
      _step;
    try {
      var _loop = function _loop() {
        var item = _step.value;
        if (item) {
          var formCommentTextarea = item.querySelector('textarea');
          var formCommentButton = item.querySelector('button');
          formCommentTextarea.addEventListener('focus', function () {
            if (!item.classList.contains('is-active')) {
              item.classList.add('is-active');
            }
          });
          formCommentTextarea.addEventListener('blur', function () {
...
/***/ "./js/modules/comment-form-reply.js":
/*!******************************************!*\
  !*** ./js/modules/comment-form-reply.js ***!
  \******************************************/
/*! exports provided: showReplyFormComment */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showReplyFormComment", function() { return showReplyFormComment; });
function _createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = _unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t.return || t.return(); } finally { if (u) throw o; } } }; }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
var commentReplyForms = document.getElementsByClassName('comment__reply');
function showReplyFormComment() {
  if (commentReplyForms.length) {
    var _iterator = _createForOfIteratorHelper(commentReplyForms),
      _step;
    try {
      var _loop = function _loop() {
        var item = _step.value;
        if (item) {
          var commentFormReplyTextarea = item.querySelector('textarea');
          var commentLinkReply = item.querySelector('.comment__link-reply');
          commentLinkReply.addEventListener('click', function (evt) {
            evt.preventDefault();
            if (!item.classList.contains('is-active')) {
              item.classList.add('is-active');
            ...
            commentFormReplyTextarea.addEventListener('blur', function () {
...
/***/ "./js/modules/favorite-slider.js":
/*!***************************************!*\
  !*** ./js/modules/favorite-slider.js ***!
  \***************************************/
/*! exports provided: initFavoriteSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFavoriteSlider", function() { return initFavoriteSlider; });
function initFavoriteSlider() {
  var SLIDER_CONTAINER_SELECTOR = '.favorites-slider__swiper-container';
  var sliderEl = document.querySelector(SLIDER_CONTAINER_SELECTOR);
  if (sliderEl) {
    // eslint-disable-next-line
    var slider = new Swiper(SLIDER_CONTAINER_SELECTOR, {
...
/***/ "./js/modules/filter-list-slider.js":
/*!******************************************!*\
  !*** ./js/modules/filter-list-slider.js ***!
  \******************************************/
/*! exports provided: initFilterListSlider, blurActiveFilterItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFilterListSlider", function() { return initFilterListSlider; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "blurActiveFilterItem", function() { return blurActiveFilterItem; });
function blurActiveFilterItem() {
  var activeFilter = document.querySelector('.filter-list__link--active');
  if (activeFilter) {
    activeFilter.removeAttribute('href');
  }
}
function initFilterListSlider() {
  var FILTER_CONTAINER_SELECTOR = '.filter-list.swiper-container';
  var filterEl = document.querySelector(FILTER_CONTAINER_SELECTOR);
  if (filterEl) {
    // eslint-disable-next-line
    var filterSlider = new Swiper(FILTER_CONTAINER_SELECTOR, {
      slidesPerView: 'auto',
      freeMode: true,
      resistanceRatio: 0
    });
...
/***/ "./js/modules/form-validate/custom-select.js":
/*!***************************************************!*\
  !*** ./js/modules/form-validate/custom-select.js ***!
  \***************************************************/
...
/***/ "./js/modules/form-validate/enter-submit-button.js":
/*!*********************************************************!*\
  !*** ./js/modules/form-validate/enter-submit-button.js ***!
  \*********************************************************/
/*! exports provided: enterSubmitButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "enterSubmitButton", function() { return enterSubmitButton; });
// функция отключает кнопку отправки форму при пустом поле

var inputElements = document.querySelectorAll('.sign-in-form__input-element');
var buttonHandler = document.querySelector('.sign-in-form__button');
var enterSubmitButton = function enterSubmitButton() {
...
var FormsValidate = /*#__PURE__*/function () {
  ...
  return _createClass(FormsValidate, [{
    key: "init",
...
/***/ "./js/modules/introduction-slider.js":
/*!*******************************************!*\
  !*** ./js/modules/introduction-slider.js ***!
  \*******************************************/
/*! exports provided: initIntroductionSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initIntroductionSlider", function() { return initIntroductionSlider; });
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function initIntroductionSlider() {
  var SLIDER_CONTAINER_SELECTOR = '.introduction-block__slider--js';
  var sliderEl = document.querySelector(SLIDER_CONTAINER_SELECTOR);
  if (sliderEl) {
    // eslint-disable-next-line
    var slider = new Swiper(SLIDER_CONTAINER_SELECTOR, {
...
/***/ "./js/modules/like-btn-change.js":
/*!***************************************!*\
  !*** ./js/modules/like-btn-change.js ***!
  \***************************************/
/*! exports provided: initChangeLikeButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initChangeLikeButton", function() { return initChangeLikeButton; });
...
var MENU_BUTTON_SELECTOR = '.main-nav__toggle';
var menuBtn = document.querySelector(MENU_BUTTON_SELECTOR);
...
/***/ "./js/modules/padding-for-main.js":
/*!****************************************!*\
  !*** ./js/modules/padding-for-main.js ***!
  \****************************************/
/*! exports provided: initBottomMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initBottomMenu", function() { return initBottomMenu; });
var TABLET_WIDTH = 1024;
var main = document.querySelector('main');
var headerMenu = document.querySelector('.header--bottom-menu');
function addMarginToMain() {
  if (window.innerWidth < TABLET_WIDTH) {
    var MENU_HEIGHT = headerMenu.offsetHeight;
    var PADDING_BOTTOM = MENU_HEIGHT + 30 + 'px';
...
/***/ "./js/modules/product-page-slider.js":
/*!*******************************************!*\
  !*** ./js/modules/product-page-slider.js ***!
  \*******************************************/
/*! exports provided: initProductPageSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initProductPageSlider", function() { return initProductPageSlider; });
function initProductPageSlider() {
  var SLIDER_CONTAINER_SELECTOR = '.product__slider-container';
  var sliderEl = document.querySelector(SLIDER_CONTAINER_SELECTOR);
  if (sliderEl) {
    // eslint-disable-next-line
    var slider = new Swiper(SLIDER_CONTAINER_SELECTOR, {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initRecommendSlider", function() { return initRecommendSlider; });
function initRecommendSlider() {
  var SLIDER_CONTAINER_SELECTOR = '.recommend-slider__slider--js';
  var sliderEl = document.querySelector(SLIDER_CONTAINER_SELECTOR);
  if (sliderEl) {
    // eslint-disable-next-line
    var slider = new Swiper(SLIDER_CONTAINER_SELECTOR, {
