...
var spinner = $('.tabs_inner_map').children('.loader-map');
...
// Функция для определения полной загрузки карты (на самом деле проверяется загрузка файлов) 
...
var ymap = function() {
  $('.tabs_inner_map').mouseenter(function(){
